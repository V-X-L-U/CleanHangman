...
public interface UserRepository {
     ...
     * @throws NotPermittedException when the user attempting user removal is not the first user (i.e., not root)
     * @throws UserNotFoundException when {@param userName} does not exist
     * @throws RepoException         see {@link RepoException}
     */
    void removeUser(String userName) throws FirstUserException, NotPermittedException, UserNotFoundException, RepoException;
